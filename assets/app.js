...
/* ============ i18n ============ */
let LANG = 'it';
function t(k){ const e = I18N[k]; return e ? (e[LANG] ?? e.it) : k; }
function setLang(l){
  LANG = l==='en'?'en':'it';
...
function initApp(){
  ...
  if('serviceWorker'in navigator&&location.protocol.startsWith('http'))navigator.serviceWorker.register(routeUrl('sw.js')).catch(()=>{});
}
