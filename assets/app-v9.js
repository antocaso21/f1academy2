const MURETTO_BUILD='20260713-pitwall-radio-v1';
/* ============ 24 GP 2026 ============ */
const CIRCUITS = [
...
function initApp(){
  ...
  if('serviceWorker'in navigator&&location.protocol.startsWith('http')){navigator.serviceWorker.register(routeUrl('sw-v9.js'),{scope:routeUrl(''),updateViaCache:'none'}).then(r=>r.update()).catch(()=>{});}
}
